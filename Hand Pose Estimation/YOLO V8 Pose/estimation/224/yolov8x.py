...
model_path = dir + "\\models\\yolo 224\\yolov8x\\best.onnx"
# model_path = dir + "\\models\\yolo 224\\yolov8x\\best_float32.tflite"
...
while True:
    ...
    if success:
        results = tflite_model.track(img,imgsz=224,persist=True,iou=0.5,)
