...
model_path = dir + "\\models\\yolo 224\\yolov8m\\best.onnx"
# model_path = dir + "\\models\\yolo 224\\yolov8m\\best_float32.tflite"
...
while True:
    ...
    if success:
        results = tflite_model.track(img,persist=True,imgsz=224)
